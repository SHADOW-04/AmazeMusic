...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("Amaze/assets/font2.ttf", 30)
        font = ImageFont.truetype("Amaze/assets/font.ttf", 30)
        title_font = ImageFont.truetype("Amaze/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("Amaze/assets/play_icons.png")
